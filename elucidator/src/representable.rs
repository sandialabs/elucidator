...
mod tests {
    ...
    mod vec_conversion {
        ...
        conversion_vec_test!(u8, as_vec_i8, vec_u8_to_vec_i8, ElucidatorError::new_narrowing("u8 array", "i8 array"));
        ...
        // u16 conversions
        conversion_vec_test!(u16, as_vec_u8, vec_u16_to_vec_u8, ElucidatorError::new_narrowing("u16 array", "u8 array"));
        conversion_vec_test!(u16, as_vec_u16, vec_u16_to_vec_u16, Ok(vec![u16::default()]));
        conversion_vec_test!(u16, as_vec_u32, vec_u16_to_vec_u32, Ok(vec![u32::default()]));
        conversion_vec_test!(u16, as_vec_u64, vec_u16_to_vec_u64, Ok(vec![u64::default()]));
        conversion_vec_test!(u16, as_vec_i8, vec_u16_to_vec_i8, ElucidatorError::new_narrowing("u16 array", "i8 array"));
        conversion_vec_test!(u16, as_vec_i16, vec_u16_to_vec_i16, ElucidatorError::new_narrowing("u16 array", "i16 array"));
        conversion_vec_test!(u16, as_vec_i32, vec_u16_to_vec_i32, Ok(vec![i32::default()]));
        conversion_vec_test!(u16, as_vec_i64, vec_u16_to_vec_i64, Ok(vec![i64::default()]));
        conversion_vec_test!(u16, as_vec_f32, vec_u16_to_vec_f32, Ok(vec![f32::default()]));
        conversion_vec_test!(u16, as_vec_f64, vec_u16_to_vec_f64, Ok(vec![f64::default()]));

        // u32 conversions
        conversion_vec_test!(u32, as_vec_u8, vec_u32_to_vec_u8, ElucidatorError::new_narrowing("u32 array", "u8 array"));
        conversion_vec_test!(u32, as_vec_u16, vec_u32_to_vec_u16, ElucidatorError::new_narrowing("u32 array", "u16 array"));
        conversion_vec_test!(u32, as_vec_u32, vec_u32_to_vec_u32, Ok(vec![u32::default()]));
        conversion_vec_test!(u32, as_vec_u64, vec_u32_to_vec_u64, Ok(vec![u64::default()]));
        conversion_vec_test!(u32, as_vec_i8, vec_u32_to_vec_i8, ElucidatorError::new_narrowing("u32 array", "i8 array"));
        conversion_vec_test!(u32, as_vec_i16, vec_u32_to_vec_i16, ElucidatorError::new_narrowing("u32 array", "i16 array"));
        conversion_vec_test!(u32, as_vec_i32, vec_u32_to_vec_i32, ElucidatorError::new_narrowing("u32 array", "i32 array"));
        conversion_vec_test!(u32, as_vec_i64, vec_u32_to_vec_i64, Ok(vec![i64::default()]));
        conversion_vec_test!(u32, as_vec_f32, vec_u32_to_vec_f32, ElucidatorError::new_narrowing("u32 array", "f32 array"));
        conversion_vec_test!(u32, as_vec_f64, vec_u32_to_vec_f64, Ok(vec![f64::default()]));

        // u64 conversions
        conversion_vec_test!(u64, as_vec_u8, vec_u64_to_vec_u8, ElucidatorError::new_narrowing("u64 array", "u8 array"));
        conversion_vec_test!(u64, as_vec_u16, vec_u64_to_vec_u16, ElucidatorError::new_narrowing("u64 array", "u16 array"));
        conversion_vec_test!(u64, as_vec_u32, vec_u64_to_vec_u32, ElucidatorError::new_narrowing("u64 array", "u32 array"));
        conversion_vec_test!(u64, as_vec_u64, vec_u64_to_vec_u64, Ok(vec![u64::default()]));
        conversion_vec_test!(u64, as_vec_i8, vec_u64_to_vec_i8, ElucidatorError::new_narrowing("u64 array", "i8 array"));
        conversion_vec_test!(u64, as_vec_i16, vec_u64_to_vec_i16, ElucidatorError::new_narrowing("u64 array", "i16 array"));
        conversion_vec_test!(u64, as_vec_i32, vec_u64_to_vec_i32, ElucidatorError::new_narrowing("u64 array", "i32 array"));
        conversion_vec_test!(u64, as_vec_i64, vec_u64_to_vec_i64, ElucidatorError::new_narrowing("u64 array", "i64 array"));
        conversion_vec_test!(u64, as_vec_f32, vec_u64_to_vec_f32, ElucidatorError::new_narrowing("u64 array", "f32 array"));
        conversion_vec_test!(u64, as_vec_f64, vec_u64_to_vec_f64, ElucidatorError::new_narrowing("u64 array", "f64 array"));

        // i8 conversions
        conversion_vec_test!(i8, as_vec_u8, vec_i8_to_vec_u8, ElucidatorError::new_narrowing("i8 array", "u8 array"));
        conversion_vec_test!(i8, as_vec_u16, vec_i8_to_vec_u16, ElucidatorError::new_narrowing("i8 array", "u16 array"));
        conversion_vec_test!(i8, as_vec_u32, vec_i8_to_vec_u32, ElucidatorError::new_narrowing("i8 array", "u32 array"));
        conversion_vec_test!(i8, as_vec_u64, vec_i8_to_vec_u64, ElucidatorError::new_narrowing("i8 array", "u64 array"));
        ...
        // i16 conversions
        conversion_vec_test!(i16, as_vec_u8, vec_i16_to_vec_u8, ElucidatorError::new_narrowing("i16 array", "u8 array"));
        conversion_vec_test!(i16, as_vec_u16, vec_i16_to_vec_u16, ElucidatorError::new_narrowing("i16 array", "u16 array"));
        conversion_vec_test!(i16, as_vec_u32, vec_i16_to_vec_u32, ElucidatorError::new_narrowing("i16 array", "u32 array"));
        conversion_vec_test!(i16, as_vec_u64, vec_i16_to_vec_u64, ElucidatorError::new_narrowing("i16 array", "u64 array"));
        conversion_vec_test!(i16, as_vec_i8, vec_i16_to_vec_i8, ElucidatorError::new_narrowing("i16 array", "i8 array"));
        conversion_vec_test!(i16, as_vec_i16, vec_i16_to_vec_i16, Ok(vec![i16::default()]));
        conversion_vec_test!(i16, as_vec_i32, vec_i16_to_vec_i32, Ok(vec![i32::default()]));
        conversion_vec_test!(i16, as_vec_i64, vec_i16_to_vec_i64, Ok(vec![i64::default()]));
        conversion_vec_test!(i16, as_vec_f32, vec_i16_to_vec_f32, Ok(vec![f32::default()]));
        conversion_vec_test!(i16, as_vec_f64, vec_i16_to_vec_f64, Ok(vec![f64::default()]));

        // i32 conversions
        conversion_vec_test!(i32, as_vec_u8, vec_i32_to_vec_u8, ElucidatorError::new_narrowing("i32 array", "u8 array"));
        conversion_vec_test!(i32, as_vec_u16, vec_i32_to_vec_u16, ElucidatorError::new_narrowing("i32 array", "u16 array"));
        conversion_vec_test!(i32, as_vec_u32, vec_i32_to_vec_u32, ElucidatorError::new_narrowing("i32 array", "u32 array"));
        conversion_vec_test!(i32, as_vec_u64, vec_i32_to_vec_u64, ElucidatorError::new_narrowing("i32 array", "u64 array"));
        conversion_vec_test!(i32, as_vec_i8, vec_i32_to_vec_i8, ElucidatorError::new_narrowing("i32 array", "i8 array"));
        conversion_vec_test!(i32, as_vec_i16, vec_i32_to_vec_i16, ElucidatorError::new_narrowing("i32 array", "i16 array"));
        conversion_vec_test!(i32, as_vec_i32, vec_i32_to_vec_i32, Ok(vec![i32::default()]));
        conversion_vec_test!(i32, as_vec_i64, vec_i32_to_vec_i64, Ok(vec![i64::default()]));
        conversion_vec_test!(i32, as_vec_f32, vec_i32_to_vec_f32, ElucidatorError::new_narrowing("i32 array", "f32 array"));
        conversion_vec_test!(i32, as_vec_f64, vec_i32_to_vec_f64, Ok(vec![f64::default()]));

        // i64 conversions
        conversion_vec_test!(i64, as_vec_u8, vec_i64_to_vec_u8, ElucidatorError::new_narrowing("i64 array", "u8 array"));
        conversion_vec_test!(i64, as_vec_u16, vec_i64_to_vec_u16, ElucidatorError::new_narrowing("i64 array", "u16 array"));
        conversion_vec_test!(i64, as_vec_u32, vec_i64_to_vec_u32, ElucidatorError::new_narrowing("i64 array", "u32 array"));
        conversion_vec_test!(i64, as_vec_u64, vec_i64_to_vec_u64, ElucidatorError::new_narrowing("i64 array", "u64 array"));
        conversion_vec_test!(i64, as_vec_i8, vec_i64_to_vec_i8, ElucidatorError::new_narrowing("i64 array", "i8 array"));
        conversion_vec_test!(i64, as_vec_i16, vec_i64_to_vec_i16, ElucidatorError::new_narrowing("i64 array", "i16 array"));
        conversion_vec_test!(i64, as_vec_i32, vec_i64_to_vec_i32, ElucidatorError::new_narrowing("i64 array", "i32 array"));
        conversion_vec_test!(i64, as_vec_i64, vec_i64_to_vec_i64, Ok(vec![i64::default()]));
        conversion_vec_test!(i64, as_vec_f32, vec_i64_to_vec_f32, ElucidatorError::new_narrowing("i64 array", "f32 array"));
        conversion_vec_test!(i64, as_vec_f64, vec_i64_to_vec_f64, ElucidatorError::new_narrowing("i64 array", "f64 array"));

        // f32 conversions
        conversion_vec_test!(f32, as_vec_u8, vec_f32_to_vec_u8, ElucidatorError::new_narrowing("f32 array", "u8 array"));
        conversion_vec_test!(f32, as_vec_u16, vec_f32_to_vec_u16, ElucidatorError::new_narrowing("f32 array", "u16 array"));
        conversion_vec_test!(f32, as_vec_u32, vec_f32_to_vec_u32, ElucidatorError::new_narrowing("f32 array", "u32 array"));
        conversion_vec_test!(f32, as_vec_u64, vec_f32_to_vec_u64, ElucidatorError::new_narrowing("f32 array", "u64 array"));
        conversion_vec_test!(f32, as_vec_i8, vec_f32_to_vec_i8, ElucidatorError::new_narrowing("f32 array", "i8 array"));
        conversion_vec_test!(f32, as_vec_i16, vec_f32_to_vec_i16, ElucidatorError::new_narrowing("f32 array", "i16 array"));
        conversion_vec_test!(f32, as_vec_i32, vec_f32_to_vec_i32, ElucidatorError::new_narrowing("f32 array", "i32 array"));
        conversion_vec_test!(f32, as_vec_i64, vec_f32_to_vec_i64, ElucidatorError::new_narrowing("f32 array", "i64 array"));
        conversion_vec_test!(f32, as_vec_f32, vec_f32_to_vec_f32, Ok(vec![f32::default()]));
        conversion_vec_test!(f32, as_vec_f64, vec_f32_to_vec_f64, Ok(vec![f64::default()]));

        // f64 conversions
        conversion_vec_test!(f64, as_vec_u8, vec_f64_to_vec_u8, ElucidatorError::new_narrowing("f64 array", "u8 array"));
        conversion_vec_test!(f64, as_vec_u16, vec_f64_to_vec_u16, ElucidatorError::new_narrowing("f64 array", "u16 array"));
        conversion_vec_test!(f64, as_vec_u32, vec_f64_to_vec_u32, ElucidatorError::new_narrowing("f64 array", "u32 array"));
        conversion_vec_test!(f64, as_vec_u64, vec_f64_to_vec_u64, ElucidatorError::new_narrowing("f64 array", "u64 array"));
        conversion_vec_test!(f64, as_vec_i8, vec_f64_to_vec_i8, ElucidatorError::new_narrowing("f64 array", "i8 array"));
        conversion_vec_test!(f64, as_vec_i16, vec_f64_to_vec_i16, ElucidatorError::new_narrowing("f64 array", "i16 array"));
        conversion_vec_test!(f64, as_vec_i32, vec_f64_to_vec_i32, ElucidatorError::new_narrowing("f64 array", "i32 array"));
        conversion_vec_test!(f64, as_vec_i64, vec_f64_to_vec_i64, ElucidatorError::new_narrowing("f64 array", "i64 array"));
        conversion_vec_test!(f64, as_vec_f32, vec_f64_to_vec_f32, ElucidatorError::new_narrowing("f64 array", "f32 array"));
        conversion_vec_test!(f64, as_vec_f64, vec_f64_to_vec_f64, Ok(vec![f64::default()]));

        // Conversions from vec<u8> to primitives and string
        conversion_vec_test!(u8, as_u8, vec_u8_to_u8, ElucidatorError::new_conversion("u8 array", "u8"));
        conversion_vec_test!(u8, as_u16, vec_u8_to_u16, ElucidatorError::new_conversion("u8 array", "u16"));
        conversion_vec_test!(u8, as_u32, vec_u8_to_u32, ElucidatorError::new_conversion("u8 array", "u32"));
        conversion_vec_test!(u8, as_u64, vec_u8_to_u64, ElucidatorError::new_conversion("u8 array", "u64"));
        conversion_vec_test!(u8, as_i8, vec_u8_to_i8, ElucidatorError::new_conversion("u8 array", "i8"));
        conversion_vec_test!(u8, as_i16, vec_u8_to_i16, ElucidatorError::new_conversion("u8 array", "i16"));
        conversion_vec_test!(u8, as_i32, vec_u8_to_i32, ElucidatorError::new_conversion("u8 array", "i32"));
        conversion_vec_test!(u8, as_i64, vec_u8_to_i64, ElucidatorError::new_conversion("u8 array", "i64"));
        conversion_vec_test!(u8, as_f32, vec_u8_to_f32, ElucidatorError::new_conversion("u8 array", "f32"));
        conversion_vec_test!(u8, as_f64, vec_u8_to_f64, ElucidatorError::new_conversion("u8 array", "f64"));
        conversion_vec_test!(u8, as_string, vec_u8_to_string, ElucidatorError::new_conversion("u8 array", "string"));

        // Conversions from vec<u16> to primitives and string
        conversion_vec_test!(u16, as_u8, vec_u16_to_u8, ElucidatorError::new_conversion("u16 array", "u8"));
        conversion_vec_test!(u16, as_u16, vec_u16_to_u16, ElucidatorError::new_conversion("u16 array", "u16"));
        conversion_vec_test!(u16, as_u32, vec_u16_to_u32, ElucidatorError::new_conversion("u16 array", "u32"));
        conversion_vec_test!(u16, as_u64, vec_u16_to_u64, ElucidatorError::new_conversion("u16 array", "u64"));
        conversion_vec_test!(u16, as_i8, vec_u16_to_i8, ElucidatorError::new_conversion("u16 array", "i8"));
        conversion_vec_test!(u16, as_i16, vec_u16_to_i16, ElucidatorError::new_conversion("u16 array", "i16"));
        conversion_vec_test!(u16, as_i32, vec_u16_to_i32, ElucidatorError::new_conversion("u16 array", "i32"));
        conversion_vec_test!(u16, as_i64, vec_u16_to_i64, ElucidatorError::new_conversion("u16 array", "i64"));
        conversion_vec_test!(u16, as_f32, vec_u16_to_f32, ElucidatorError::new_conversion("u16 array", "f32"));
        conversion_vec_test!(u16, as_f64, vec_u16_to_f64, ElucidatorError::new_conversion("u16 array", "f64"));
        conversion_vec_test!(u16, as_string, vec_u16_to_string, ElucidatorError::new_conversion("u16 array", "string"));

        // Conversions from vec<u32> to primitives and string
        conversion_vec_test!(u32, as_u8, vec_u32_to_u8, ElucidatorError::new_conversion("u32 array", "u8"));
        conversion_vec_test!(u32, as_u16, vec_u32_to_u16, ElucidatorError::new_conversion("u32 array", "u16"));
        conversion_vec_test!(u32, as_u32, vec_u32_to_u32, ElucidatorError::new_conversion("u32 array", "u32"));
        conversion_vec_test!(u32, as_u64, vec_u32_to_u64, ElucidatorError::new_conversion("u32 array", "u64"));
        conversion_vec_test!(u32, as_i8, vec_u32_to_i8, ElucidatorError::new_conversion("u32 array", "i8"));
        conversion_vec_test!(u32, as_i16, vec_u32_to_i16, ElucidatorError::new_conversion("u32 array", "i16"));
        conversion_vec_test!(u32, as_i32, vec_u32_to_i32, ElucidatorError::new_conversion("u32 array", "i32"));
        conversion_vec_test!(u32, as_i64, vec_u32_to_i64, ElucidatorError::new_conversion("u32 array", "i64"));
        conversion_vec_test!(u32, as_f32, vec_u32_to_f32, ElucidatorError::new_conversion("u32 array", "f32"));
        conversion_vec_test!(u32, as_f64, vec_u32_to_f64, ElucidatorError::new_conversion("u32 array", "f64"));
        conversion_vec_test!(u32, as_string, vec_u32_to_string, ElucidatorError::new_conversion("u32 array", "string"));

        // Conversions from vec<u64> to primitives and string
        conversion_vec_test!(u64, as_u8, vec_u64_to_u8, ElucidatorError::new_conversion("u64 array", "u8"));
        conversion_vec_test!(u64, as_u16, vec_u64_to_u16, ElucidatorError::new_conversion("u64 array", "u16"));
        conversion_vec_test!(u64, as_u32, vec_u64_to_u32, ElucidatorError::new_conversion("u64 array", "u32"));
        conversion_vec_test!(u64, as_u64, vec_u64_to_u64, ElucidatorError::new_conversion("u64 array", "u64"));
        conversion_vec_test!(u64, as_i8, vec_u64_to_i8, ElucidatorError::new_conversion("u64 array", "i8"));
        conversion_vec_test!(u64, as_i16, vec_u64_to_i16, ElucidatorError::new_conversion("u64 array", "i16"));
        conversion_vec_test!(u64, as_i32, vec_u64_to_i32, ElucidatorError::new_conversion("u64 array", "i32"));
        conversion_vec_test!(u64, as_i64, vec_u64_to_i64, ElucidatorError::new_conversion("u64 array", "i64"));
        conversion_vec_test!(u64, as_f32, vec_u64_to_f32, ElucidatorError::new_conversion("u64 array", "f32"));
        conversion_vec_test!(u64, as_f64, vec_u64_to_f64, ElucidatorError::new_conversion("u64 array", "f64"));
        conversion_vec_test!(u64, as_string, vec_u64_to_string, ElucidatorError::new_conversion("u64 array", "string"));

        // Conversions from vec<i8> to primitives and string
        conversion_vec_test!(i8, as_u8, vec_i8_to_u8, ElucidatorError::new_conversion("i8 array", "u8"));
        conversion_vec_test!(i8, as_u16, vec_i8_to_u16, ElucidatorError::new_conversion("i8 array", "u16"));
        conversion_vec_test!(i8, as_u32, vec_i8_to_u32, ElucidatorError::new_conversion("i8 array", "u32"));
        conversion_vec_test!(i8, as_u64, vec_i8_to_u64, ElucidatorError::new_conversion("i8 array", "u64"));
        conversion_vec_test!(i8, as_i8, vec_i8_to_i8, ElucidatorError::new_conversion("i8 array", "i8"));
        conversion_vec_test!(i8, as_i16, vec_i8_to_i16, ElucidatorError::new_conversion("i8 array", "i16"));
        conversion_vec_test!(i8, as_i32, vec_i8_to_i32, ElucidatorError::new_conversion("i8 array", "i32"));
        conversion_vec_test!(i8, as_i64, vec_i8_to_i64, ElucidatorError::new_conversion("i8 array", "i64"));
        conversion_vec_test!(i8, as_f32, vec_i8_to_f32, ElucidatorError::new_conversion("i8 array", "f32"));
        conversion_vec_test!(i8, as_f64, vec_i8_to_f64, ElucidatorError::new_conversion("i8 array", "f64"));
        conversion_vec_test!(i8, as_string, vec_i8_to_string, ElucidatorError::new_conversion("i8 array", "string"));

        // Conversions from vec<i16> to primitives and string
        conversion_vec_test!(i16, as_u8, vec_i16_to_u8, ElucidatorError::new_conversion("i16 array", "u8"));
        conversion_vec_test!(i16, as_u16, vec_i16_to_u16, ElucidatorError::new_conversion("i16 array", "u16"));
        conversion_vec_test!(i16, as_u32, vec_i16_to_u32, ElucidatorError::new_conversion("i16 array", "u32"));
        conversion_vec_test!(i16, as_u64, vec_i16_to_u64, ElucidatorError::new_conversion("i16 array", "u64"));
        conversion_vec_test!(i16, as_i8, vec_i16_to_i8, ElucidatorError::new_conversion("i16 array", "i8"));
        conversion_vec_test!(i16, as_i16, vec_i16_to_i16, ElucidatorError::new_conversion("i16 array", "i16"));
        conversion_vec_test!(i16, as_i32, vec_i16_to_i32, ElucidatorError::new_conversion("i16 array", "i32"));
        conversion_vec_test!(i16, as_i64, vec_i16_to_i64, ElucidatorError::new_conversion("i16 array", "i64"));
        conversion_vec_test!(i16, as_f32, vec_i16_to_f32, ElucidatorError::new_conversion("i16 array", "f32"));
        conversion_vec_test!(i16, as_f64, vec_i16_to_f64, ElucidatorError::new_conversion("i16 array", "f64"));
        conversion_vec_test!(i16, as_string, vec_i16_to_string, ElucidatorError::new_conversion("i16 array", "string"));

        // Conversions from vec<i32> to primitives and string
        conversion_vec_test!(i32, as_u8, vec_i32_to_u8, ElucidatorError::new_conversion("i32 array", "u8"));
        conversion_vec_test!(i32, as_u16, vec_i32_to_u16, ElucidatorError::new_conversion("i32 array", "u16"));
        conversion_vec_test!(i32, as_u32, vec_i32_to_u32, ElucidatorError::new_conversion("i32 array", "u32"));
        conversion_vec_test!(i32, as_u64, vec_i32_to_u64, ElucidatorError::new_conversion("i32 array", "u64"));
        conversion_vec_test!(i32, as_i8, vec_i32_to_i8, ElucidatorError::new_conversion("i32 array", "i8"));
        conversion_vec_test!(i32, as_i16, vec_i32_to_i16, ElucidatorError::new_conversion("i32 array", "i16"));
        conversion_vec_test!(i32, as_i32, vec_i32_to_i32, ElucidatorError::new_conversion("i32 array", "i32"));
        conversion_vec_test!(i32, as_i64, vec_i32_to_i64, ElucidatorError::new_conversion("i32 array", "i64"));
        conversion_vec_test!(i32, as_f32, vec_i32_to_f32, ElucidatorError::new_conversion("i32 array", "f32"));
        conversion_vec_test!(i32, as_f64, vec_i32_to_f64, ElucidatorError::new_conversion("i32 array", "f64"));
        conversion_vec_test!(i32, as_string, vec_i32_to_string, ElucidatorError::new_conversion("i32 array", "string"));

        // Conversions from vec<i64> to primitives and string
        conversion_vec_test!(i64, as_u8, vec_i64_to_u8, ElucidatorError::new_conversion("i64 array", "u8"));
        conversion_vec_test!(i64, as_u16, vec_i64_to_u16, ElucidatorError::new_conversion("i64 array", "u16"));
        conversion_vec_test!(i64, as_u32, vec_i64_to_u32, ElucidatorError::new_conversion("i64 array", "u32"));
        conversion_vec_test!(i64, as_u64, vec_i64_to_u64, ElucidatorError::new_conversion("i64 array", "u64"));
        conversion_vec_test!(i64, as_i8, vec_i64_to_i8, ElucidatorError::new_conversion("i64 array", "i8"));
        conversion_vec_test!(i64, as_i16, vec_i64_to_i16, ElucidatorError::new_conversion("i64 array", "i16"));
        conversion_vec_test!(i64, as_i32, vec_i64_to_i32, ElucidatorError::new_conversion("i64 array", "i32"));
        conversion_vec_test!(i64, as_i64, vec_i64_to_i64, ElucidatorError::new_conversion("i64 array", "i64"));
        conversion_vec_test!(i64, as_f32, vec_i64_to_f32, ElucidatorError::new_conversion("i64 array", "f32"));
        conversion_vec_test!(i64, as_f64, vec_i64_to_f64, ElucidatorError::new_conversion("i64 array", "f64"));
        conversion_vec_test!(i64, as_string, vec_i64_to_string, ElucidatorError::new_conversion("i64 array", "string"));

        // Conversions from vec<f32> to primitives and string
        conversion_vec_test!(f32, as_u8, vec_f32_to_u8, ElucidatorError::new_conversion("f32 array", "u8"));
        conversion_vec_test!(f32, as_u16, vec_f32_to_u16, ElucidatorError::new_conversion("f32 array", "u16"));
        conversion_vec_test!(f32, as_u32, vec_f32_to_u32, ElucidatorError::new_conversion("f32 array", "u32"));
        conversion_vec_test!(f32, as_u64, vec_f32_to_u64, ElucidatorError::new_conversion("f32 array", "u64"));
        conversion_vec_test!(f32, as_i8, vec_f32_to_i8, ElucidatorError::new_conversion("f32 array", "i8"));
        conversion_vec_test!(f32, as_i16, vec_f32_to_i16, ElucidatorError::new_conversion("f32 array", "i16"));
        conversion_vec_test!(f32, as_i32, vec_f32_to_i32, ElucidatorError::new_conversion("f32 array", "i32"));
        conversion_vec_test!(f32, as_i64, vec_f32_to_i64, ElucidatorError::new_conversion("f32 array", "i64"));
        conversion_vec_test!(f32, as_f32, vec_f32_to_f32, ElucidatorError::new_conversion("f32 array", "f32"));
        conversion_vec_test!(f32, as_f64, vec_f32_to_f64, ElucidatorError::new_conversion("f32 array", "f64"));
        conversion_vec_test!(f32, as_string, vec_f32_to_string, ElucidatorError::new_conversion("f32 array", "string"));

        // Conversions from vec<f64> to primitives and string
        conversion_vec_test!(f64, as_u8, vec_f64_to_u8, ElucidatorError::new_conversion("f64 array", "u8"));
        conversion_vec_test!(f64, as_u16, vec_f64_to_u16, ElucidatorError::new_conversion("f64 array", "u16"));
        conversion_vec_test!(f64, as_u32, vec_f64_to_u32, ElucidatorError::new_conversion("f64 array", "u32"));
        conversion_vec_test!(f64, as_u64, vec_f64_to_u64, ElucidatorError::new_conversion("f64 array", "u64"));
        conversion_vec_test!(f64, as_i8, vec_f64_to_i8, ElucidatorError::new_conversion("f64 array", "i8"));
        conversion_vec_test!(f64, as_i16, vec_f64_to_i16, ElucidatorError::new_conversion("f64 array", "i16"));
        conversion_vec_test!(f64, as_i32, vec_f64_to_i32, ElucidatorError::new_conversion("f64 array", "i32"));
        conversion_vec_test!(f64, as_i64, vec_f64_to_i64, ElucidatorError::new_conversion("f64 array", "i64"));
        conversion_vec_test!(f64, as_f32, vec_f64_to_f32, ElucidatorError::new_conversion("f64 array", "f32"));
        conversion_vec_test!(f64, as_f64, vec_f64_to_f64, ElucidatorError::new_conversion("f64 array", "f64"));
    ...
    mod primitive_conversion {
        ...
        conversion_test!(u8, as_string, u8_to_string, ElucidatorError::new_conversion("u8", "string"));
        ...
        conversion_test!(u16, as_string, u16_to_string, ElucidatorError::new_conversion("u16", "string"));
        ...
        conversion_test!(u32, as_string, u32_to_string, ElucidatorError::new_conversion("u32", "string"));
        ...
        conversion_test!(u64, as_string, u64_to_string, ElucidatorError::new_conversion("u64", "string"));
        ...
        conversion_test!(i8, as_string, i8_to_string, ElucidatorError::new_conversion("i8", "string"));
        ...
        conversion_test!(i16, as_string, i16_to_string, ElucidatorError::new_conversion("i16", "string"));
        ...
        conversion_test!(i32, as_string, i32_to_string, ElucidatorError::new_conversion("i32", "string"));
        ...
        conversion_test!(i64, as_string, i64_to_string, ElucidatorError::new_conversion("i64", "string"));
        ...
        conversion_test!(f32, as_string, f32_to_string, ElucidatorError::new_conversion("f32", "string"));
        ...
        conversion_test!(f64, as_string, f64_to_string, ElucidatorError::new_conversion("f64", "string"));
